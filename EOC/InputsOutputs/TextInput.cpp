...
void TextInput::setBackgroundColor(Color color1, Color color2,double thicc)
{
	_background->setFillColor(color1);
	if (color2 != Color::Transparent && thicc != 0) {
		_background->setOutlineThickness(thicc);
		_background->setOutlineColor(color2);
	}
}
...
void TextInput::setValue(const wstring& value)
{
	_input = value;
